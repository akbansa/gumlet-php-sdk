...
class ImageSources400Error3Exception extends ApiException
{
    /**
    ...
    /**
     * Converts the ImageSources400Error3Exception object to a human-readable string representation.
     *
     * @return string The string representation of the ImageSources400Error3Exception object.
     */
