...
class VideoAssetsList400ErrorException extends ApiException
{
    /**
    ...
    /**
     * Converts the VideoAssetsList400ErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the VideoAssetsList400ErrorException object.
     */
