...
class InsightsBreakdownData401ErrorException extends ApiException
{
    /**
    ...
    /**
     * Converts the InsightsBreakdownData401ErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the InsightsBreakdownData401ErrorException object.
     */
