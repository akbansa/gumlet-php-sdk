...
class VideoPlaylistAssets400ErrorException extends ApiException
{
    /**
    ...
    /**
     * Converts the VideoPlaylistAssets400ErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the VideoPlaylistAssets400ErrorException object.
     */
