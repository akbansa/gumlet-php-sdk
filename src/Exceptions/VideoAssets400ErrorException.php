...
class VideoAssets400ErrorException extends ApiException
{
    /**
    ...
    /**
     * Converts the VideoAssets400ErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the VideoAssets400ErrorException object.
     */
