...
class VideoLiveAssetsUpdate400ErrorException extends ApiException
{
    /**
    ...
    /**
     * Converts the VideoLiveAssetsUpdate400ErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the VideoLiveAssetsUpdate400ErrorException object.
     */
