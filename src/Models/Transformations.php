...
class Transformations implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Transformations object to a human-readable string representation.
     *
     * @return string The string representation of the Transformations object.
     */
