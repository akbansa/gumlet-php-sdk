...
class VideoAssetsResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the VideoAssetsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the VideoAssetsResponse object.
     */
