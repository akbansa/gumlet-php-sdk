...
class Input2 implements \JsonSerializable
{
    /**
     * @var Transformations2|null
     */
     ...
     */
    public function getTransformations(): ?Transformations2
    {
     ...
     */
    public function setTransformations(?Transformations2 $transformations): void
    {
    ...
    /**
     * Converts the Input2 object to a human-readable string representation.
     *
     * @return string The string representation of the Input2 object.
     */
