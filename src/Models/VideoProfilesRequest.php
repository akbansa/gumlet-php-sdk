...
class VideoProfilesRequest implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the VideoProfilesRequest object to a human-readable string representation.
     *
     * @return string The string representation of the VideoProfilesRequest object.
     */
