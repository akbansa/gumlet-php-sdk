 ...
 */
class Dostorage implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Dostorage object to a human-readable string representation.
     *
     * @return string The string representation of the Dostorage object.
     */
