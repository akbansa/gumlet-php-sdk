...
class ImageSourcesResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ImageSourcesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ImageSourcesResponse object.
     */
