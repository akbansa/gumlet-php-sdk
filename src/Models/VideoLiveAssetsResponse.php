...
class VideoLiveAssetsResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the VideoLiveAssetsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the VideoLiveAssetsResponse object.
     */
