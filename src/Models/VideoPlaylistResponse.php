...
class VideoPlaylistResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the VideoPlaylistResponse object to a human-readable string representation.
     *
     * @return string The string representation of the VideoPlaylistResponse object.
     */
