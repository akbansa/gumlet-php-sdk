 ...
 */
class Aws4 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Aws4 object to a human-readable string representation.
     *
     * @return string The string representation of the Aws4 object.
     */
