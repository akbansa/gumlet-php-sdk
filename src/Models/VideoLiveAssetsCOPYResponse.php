...
class VideoLiveAssetsCOPYResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the VideoLiveAssetsCOPYResponse object to a human-readable string representation.
     *
     * @return string The string representation of the VideoLiveAssetsCOPYResponse object.
     */
