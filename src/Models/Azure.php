 ...
 */
class Azure implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Azure object to a human-readable string representation.
     *
     * @return string The string representation of the Azure object.
     */
