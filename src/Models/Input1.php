...
class Input1 implements \JsonSerializable
{
    /**
     * @var Transformations1|null
     */
     ...
     */
    public function getTransformations(): ?Transformations1
    {
     ...
     */
    public function setTransformations(?Transformations1 $transformations): void
    {
     ...
     *
     * @param CallToAction3[]|null $callToActions
     */
    ...
    /**
     * Converts the Input1 object to a human-readable string representation.
     *
     * @return string The string representation of the Input1 object.
     */
