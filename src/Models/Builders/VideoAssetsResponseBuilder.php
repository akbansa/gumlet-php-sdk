...
/**
 * Builder for model VideoAssetsResponse
 *
 * @see VideoAssetsResponse
 */
class VideoAssetsResponseBuilder
{
    /**
     * @var VideoAssetsResponse
     */
    private $instance;

    private function __construct(VideoAssetsResponse $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Video Assets Response Builder object.
     */
    public static function init(): self
    {
        return new self(new VideoAssetsResponse());
    }
     ...
     * Sets input field.
     *
     * @param Input|null $value
     */
    public function input(?Input $value): self
    {
    ...
    /**
     * Initializes a new Video Assets Response object.
     */
    public function build(): VideoAssetsResponse
    {
