...
/**
 * Builder for model PlayerConfig
 *
 * @see PlayerConfig
 */
class PlayerConfigBuilder
{
    ...
    private function __construct(PlayerConfig $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Player Config Builder object.
     */
    public static function init(): self
    {
        return new self(new PlayerConfig());
    }
    ...
    /**
     * Initializes a new Player Config object.
     */
    public function build(): PlayerConfig
    {
