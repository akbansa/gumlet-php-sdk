...
/**
 * Builder for model VideoSourcesRequest1
 *
 * @see VideoSourcesRequest1
 */
class VideoSourcesRequest1Builder
{
    /**
     * @var VideoSourcesRequest1
     */
    private $instance;

    private function __construct(VideoSourcesRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Video Sources Request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new VideoSourcesRequest1());
    }
     ...
     *
     * @param ChannelSettings2|null $value
     */
    public function channelSettings(?ChannelSettings2 $value): self
    {
     ...
     *
     * @param Webfolder|null $value
     */
    public function webfolder(?Webfolder $value): self
    {
    ...
    /**
     * Initializes a new Video Sources Request 1 object.
     */
    public function build(): VideoSourcesRequest1
    {
