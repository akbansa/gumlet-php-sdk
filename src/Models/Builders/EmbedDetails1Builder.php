...
/**
 * Builder for model EmbedDetails1
 *
 * @see EmbedDetails1
 */
class EmbedDetails1Builder
{
    /**
     * @var EmbedDetails1
     */
    ...
    private function __construct(EmbedDetails1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Embed Details 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new EmbedDetails1());
    }
    ...
    /**
     * Initializes a new Embed Details 1 object.
     */
    public function build(): EmbedDetails1
    {
