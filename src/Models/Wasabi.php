 ...
 */
class Wasabi implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Wasabi object to a human-readable string representation.
     *
     * @return string The string representation of the Wasabi object.
     */
