...
class GumletRestApisClientBuilder
{
    /**
     * @var array
     */
    ...
    /**
     * @see GumletRestApisClientBuilder::customHeaderAuthenticationCredentials
     *
    ...
    public function build(): GumletRestApisClient
    {
        return new GumletRestApisClient($this->config);
    }
}
